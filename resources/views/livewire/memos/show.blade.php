...
state(['memo' => null, 'showDeleteConfirmation' => false]);
...
<div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
    <div class="bg-indigo-50 shadow-sm rounded-lg p-6">
        ...
        <div class="text-sm text-indigo-600 mb-6">
    ...
    <!-- 削除確認モーダル -->
    <div x-data x-show="$wire.showDeleteConfirmation"
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900">メモの削除</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">このメモを削除してもよろしいですか？この操作は取り消せません。</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button wire:click="deleteMemo" type="button"
